import {
  ...
  CHANGE_DEFAULT_SETTINGS, CHANGE_DELETE_FILES_AFTER_ENCRYPT, CHANGE_ECRYPT_ALGORITHM,
  CHANGE_ECRYPT_ENCODING, CHANGE_LOCALE, CHANGE_OCSP_PROXY_LOGIN,
  CHANGE_OCSP_PROXY_PASSWORD, CHANGE_OCSP_PROXY_PORT,
  CHANGE_OCSP_PROXY_URL, CHANGE_OCSP_URL, CHANGE_OCSP_USE_PROXY,
  ...
  TOGGLE_REVERSE_OPERATIONS, TOGGLE_SAVE_COPY_TO_DOCUMENTS, TOGGLE_SAVE_RESULT_TO_FOLDER, TOGGLE_SAVE_TO_DOCUMENTS, TOGGLE_SIGNING_OPERATION,
} from "../constants";
