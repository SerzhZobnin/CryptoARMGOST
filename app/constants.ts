...
export const SHA1RSADI = "1.2.840.113549.1.1.5";
export const MD5RSA1 = "1.2.840.113549.1.1.4";
export const SHA1DSA = "1.2.840.10040.4.3";
export const SHA1RSA = "1.3.14.3.2.29";
export const SHARSA =  "1.3.14.3.2.15";
export const MD5RSA = "1.3.14.3.2.3";
export const MD2RSA1 = "1.2.840.113549.1.1.2";
export const MD4RSAPK = "1.2.840.113549.1.1.3";
export const MD4RSA1 = "1.3.14.3.2.2";
export const MD4RSA = "1.3.14.3.2.4";
export const MD2RSA = "1.3.14.7.2.3.1";
export const SHA1DSA1 = "1.3.14.3.2.13";
export const DSASHA1 = "1.3.14.3.2.27";
export const MOSAICUPDATEDSIG = "2.16.840.1.101.2.1.1.19";
export const SHA1NOSIGN = "1.3.14.3.2.26";
export const MD5NOSIGN = "1.2.840.113549.2.5";
export const SHA256NOSIGN = "2.16.840.1.101.3.4.2.1";
export const SHA384NOSIGN = "2.16.840.1.101.3.4.2.2";
export const SHA512NOSIGN = "2.16.840.1.101.3.4.2.3";
export const SHA256RSA = "1.2.840.113549.1.1.11";
export const SHA384RSA = "1.2.840.113549.1.1.12";
export const SHA512RSA = "1.2.840.113549.1.1.13";
export const RSASSAPSS = "1.2.840.113549.1.1.10";
export const SHA1ECDSA = "1.2.840.10045.4.1";
export const SHA256ECDSA = "1.2.840.10045.4.3.2";
export const SHA384ECDSA = "1.2.840.10045.4.3.3";
export const SHA512ECDSA = "1.2.840.10045.4.3.4";
export const SPECIFIEDECDSA = "1.2.840.10045.4.3";

// 2.4.1.3 Public Key OID
export const RSA = "1.2.840.113549.1.1.1";
export const DSAKEY = "1.2.840.10040.4.1";
export const DHKEY = "1.2.840.10046.2.1";
export const RSASSAPSSKEY = "1.2.840.113549.1.1.10";
export const DSA = "1.3.14.3.2.12";
export const DH = "1.2.840.113549.1.3.1";
export const RSA_KEYX = "1.3.14.3.2.22";
export const mosaicKMandUpdSig = "2.16.840.1.101.2.1.1.20";
export const ESDH = "1.2.840.113549.1.9.16.3.5";
export const NO_SIGN = "1.3.6.1.5.5.7.6.2";
export const ECC = "1.2.840.10045.2.1";
export const ECDSA_P256 = "1.2.840.10045.3.1.7";
export const ECDSA_P384 = "1.3.132.0.34";
export const ECDSA_P521 = "1.3.132.0.35";
export const RSAES_OAEP = "1.2.840.113549.1.1.7";
export const ECDH_STD_SHA1_KDF = "1.3.133.16.840.63.0.2";
