...
export default {
  About: {
    ...
    version_full: "Версия продукта: 2.1.2",
  },
  Agreement: {
  ...
  Sign: {
    ...
    status: "Статус",
    timestamp_on_data: "Добавлять штамп времени на подписываемые данные",
    timestamp_on_sign: "Добавлять штамп времени на подпись",
